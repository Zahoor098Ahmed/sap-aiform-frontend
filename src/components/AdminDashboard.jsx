...
const AdminDashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      const response = await fetch('http://localhost:5001/api/feedback/stats');
  ...
  const exportToExcel = async () => {
    try {
      ...
      const response = await fetch('http://localhost:5001/api/feedback/export');
      ...
      link.href = url;
      link.download = `feedback-export-${new Date().toISOString().split('T')[0]}.xlsx`;
      link.click();
  ...
  const generateQRCode = async () => {
    try {
      ...
      const feedbackFormUrl = 'https://saphrsesummit.online/';
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5001/api/feedback/${feedbackToDelete}`, {
        method: 'DELETE'
      });
      ...
      setFeedback(feedback.filter(item => (item._id || item.id) !== feedbackToDelete));
  ...
  const renderTabNavigation = () => (
    <div className="tab-navigation">
      ...
      <button 
        className={`tab-btn ${currentAdminView === 'responses' ? 'active' : ''}`}
    ...
    <div className="qr-view">
      <div className="view-header">
        ...
        <div className="header-text">
            ...
            <p>During the event, display this QR code for attendees to access the feedback form</p>
          </div>
      </div>
        ...
        <div className="qr-content">
            ...
            {qrLoading ? (
              ...
              <>
                ...
                <div className="qr-url">
                  <strong>URL:</strong> https://saphrsesummit.online/
                </div>
              </>
            ) : (
          ...
          {qrCode && (
            <div className="qr-actions">
              <button onClick={downloadQRCode} className="qr-action-btn download-btn">
                <Icons.Download />
              ...
              <button onClick={generateQRCode} className="qr-action-btn refresh-btn">
                <Icons.Refresh />
          ...
          <div className="qr-instructions">
            ...
            <div className="instruction-item">
              ...
              <div className="instruction-text">
                ...
                <p>Visitors can scan it with their phone camera or QR code app</p>
              </div>
            </div>
            <div className="instruction-item">
              <div className="instruction-icon">
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="feedback-detail">
                ...
                <span 
                  className="topic-badge"
                  style={{ backgroundColor: getTopicColor(selectedFeedback.topic) }}
                >
